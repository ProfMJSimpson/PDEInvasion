...
@time sol=pdesolver(dξ,N,T,u0,κ,ξ); 
LL=zeros(length(T))
LL[:]=sol[N+1,:]
...
p1=plot(ξ*LL[1],sol[1:1:N,1],lw=2,color=:blue,xlims=(50,150),ylims=(0,1.1),legend=false)
p1=plot!(ξ*LL[2],sol[1:1:N,2],lw=2,color=:blue,xlims=(50,150),ylims=(0,1.1),legend=false)
p1=plot!(ξ*LL[11],sol[1:1:N,11],lw=2,color=:blue,xlims=(50,150),ylims=(0,1.1),legend=false)
p1=plot!(ξ*LL[21],sol[1:1:N,21],lw=2,color=:blue,xlims=(50,150),ylims=(0,1.1),legend=false)
p1=plot!(ξ*LL[31],sol[1:1:N,31],lw=2,color=:blue,xlims=(50,150),ylims=(0,1.1),legend=false)
p1=plot!(ξ*LL[41],sol[1:1:N,41],lw=2,color=:blue,xlims=(50,150),ylims=(0,1.1),legend=false)
p1=plot!(ξ*LL[51],sol[1:1:N,51],lw=2,color=:blue,xlims=(50,150),ylims=(0,1.1),legend=false)
